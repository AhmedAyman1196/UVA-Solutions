...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		int t = sc.nextInt() ; 
		for(int i = 1 ;  i <=t ;  i ++){
			Rectangle r1 = new Rectangle(new Point(sc.nextDouble() ,  sc.nextDouble()),
					new Point(sc.nextDouble() ,  sc.nextDouble()))  ;
			Rectangle r2 = new Rectangle(new Point(sc.nextDouble() ,  sc.nextDouble()),
					new Point(sc.nextDouble() ,  sc.nextDouble()))  ;
			Rectangle result = r1.intersect(r2); 
			int secured = 0 ; 
			if(result!=null)secured = (int) result.area();
			int total = (int) (r1.area() + r2.area()) ; 
			int weak = (int) (total-2*secured);
			int un = (int) (100*100 - weak - secured) ; 
			pw.printf("Night %d: %d %d %d\n" , i , secured , weak , un);
		}
